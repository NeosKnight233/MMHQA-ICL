import json
import os
from utils.qpmc import Question_Passage_Match_Classifier
from utils.qimc import Question_Image_Match_Classifier
...
class RetrieverBD:
    def __init__(self):
        self.qpmc = Question_Passage_Match_Classifier()
        self.qimc = Question_Image_Match_Classifier()
    ...
    def retrieve(self, g_data_item, eid = None, qid = None):
        ...
        for _id, title, text, url in zip(g_data_item['passages']['id'],
            ...
            if self.qpmc.judge_match(question=g_data_item['question'], passage=text):
        ...
        for _id, title, pic, url, path in zip(g_data_item['images']['id'],
            ...
            if self.qimc.judge_match(g_data_item['id'], g_data_item['question'], pic):
        ...
        return new_passages, new_images, None
