...
import openai
from qa.prompt import PromptBuilder
import random
import os
import json
        ...
        while result is None:
            try:
                if engine.lower() in ["llava","llava-13b","llava-7b"]:
                    ...
                    result = api.create(api_args, self.args.verbose)

                    print('LLaVA inference time:', time.time() - start_time)
                    return True, result
                else:
                    # TODO: 增加 text-davinci-003 engine
